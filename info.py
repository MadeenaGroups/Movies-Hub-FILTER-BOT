...
API_ID = int(environ.get('API_ID', '2426794
'))
API_HASH = environ.get('API_HASH', '85092fd90c9bd5ca68867e5b4eedc935
')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7376932937 6569643738').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002749895559'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002202639945').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002812378546') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-4845772726')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002999307136').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://movieshubclustor0:3bAYnOKSDi9TLmGv@cluster0.frub9mn.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "movieshubfilterbot")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+gPUWdBqhss40MDQ8')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/newhdmovies0971')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+yT4fJeTIWW01ODA8') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/cinemacafe0971')
